	...
	<div class="section__content section__content--p30">
		<div class="container-fluid">
			<div class="fontawesome-list-wrap">
				...
				<form:form action="insertProductType" method="post" modelAttribute="type"
					...
					<div class="form-group">
						...
						<div class=" col-md-9">
							<form:input type="text" id="type-name" path="name"
								placeholder="Enter product's name..." class="form-control" /> <span
								class="help-block">Please enter product's name</span>
						</div>
					</div>
